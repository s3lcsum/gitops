locals {
  ...
  oauth2_applications = {
    ...
    proxmox = {
      ...
      icon_url      = "https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/proxmox.png"
    }
    netbox = {
      name          = "NetBox"
      slug          = "netbox"
      ...
      icon_url      = "https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/netbox.png"
    }
    vaultwarden = {
      name          = "Vaultwarden"
      slug          = "vaultwarden"
    ...
    synology = {
      ...
      icon_url      = "https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/synology-dsm.png"
    }
    n8n = {
      name          = "N8n"
      slug          = "n8n"
    ...
    warrtracker = {
      ...
      icon_url      = "https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/warrtracker.png"
    }
  }
  ...
  proxy_applications = {
    ...
    cups = {
      ...
      icon_url        = "https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/cups.png"
      skip_path_regex = ""
    }
    dozzle = {
      name            = "Dozzle"
  ...
  dashboard_applications = {
    adguard = {
      ...
      icon_url   = "https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/adguard-home.png"
    }
    calibre = {
      name       = "Calibre"
      slug       = "calibre"
      launch_url = "https://calibre.lake.dominiksiejak.pl"
      icon_url   = "https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/calibre-web.png"
    }
    qbittorrent = {
      name       = "qBittorrent"
      slug       = "qbittorrent"
    ...
    upsnap = {
      ...
      icon_url   = "https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/upsnap.png"
    }
    jellyfin = {
      name       = "Jellyfin"
      slug       = "jellyfin"
      launch_url = "https://jellyfin.lake.dominiksiejak.pl"
      icon_url   = "https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/jellyfin.png"
    }
    jellyseerr = {
      name       = "Jellyseerr"
      slug       = "jellyseerr"
      launch_url = "https://jellyseerr.lake.dominiksiejak.pl"
      icon_url   = "https://cdn.jsdelivr.net/gh/walkxcode/dashboard-icons/png/jellyseerr.png"
    }
  }
}
